...
namespace TicketShop.Web
{
        ...
        
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(Repository<>), typeof(RepositoryImpl<>));
            services.AddScoped(typeof(IUserRepository), typeof(UserRepositoryImpl));
            ...
            services.AddTransient < TicketService, TicketServiceImpl>();
            services.AddTransient<ShoppingCartService, ShoppingCartServiceImpl>();
            services.AddTransient< Service.Interface.OrderService,OrderServiceImpl>();
