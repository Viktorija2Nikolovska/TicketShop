...
namespace TicketShop.Web.Controllers
{
    public class TicketsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Create([Bind("TicketName,TicketImage,TicketDescription,TicketPrice,Rating,ValidDate,Id")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(Guid id, [Bind("TicketName,TicketImage,TicketDescription,TicketPrice,Rating,ValidDate,Id")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();
